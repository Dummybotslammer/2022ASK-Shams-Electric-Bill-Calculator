...
def reset_language(language):
	...
	#menu buttons
	m = [
	classes.Button(pygame.Rect(10, 40, 145, 85), [], orange, black, 1, 0, pygame.image.load(os.path.join(sourceFileDir, "existing_invoices.png"))), 
	classes.Button(pygame.Rect(165, 40, 145, 85), [], orange, black, 1, 1, pygame.image.load(os.path.join(sourceFileDir, "new_invoice.png"))),
...
def main():
	...
	font_img = pygame.image.load(os.path.join(sourceFileDir, 'fonts.png'))
